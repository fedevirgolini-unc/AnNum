...
def min_fun_lab2ej8():
    """
    Esta función calcula el mínimo de la función f(x)=(tan(x))/x**2 en el intervalo (0, pi/2)mediante el cálculo de la raíz de su derivada (utilizando el método de Newton).
    """
